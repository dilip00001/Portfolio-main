...
const skillsImg3 = "https://skillicons.dev/icons?i=tailwind,nextjs";
const skillsImg4 = "https://skillicons.dev/icons?i=ts,github";
const linkedin = "https://www.linkedin.com/in/dilip-kumar-d/";
const github = "https://github.com/dilip00001";
          ...
          <div className="content">
            <div className="hero-main">
              <div className="hero-text">
                ...
                />
                <p>
                  Hi, I'm Dilip Kumar. A passionate Front-React Developer based
                  in Chennai, India 🇮🇳. 📍
                </p>
                <span>
                  <a
            ...
            <div className="skills">
              ...
              <div className="logos">
                <ul>
                  ...
                  <li>
                    <img src={skillsImg4} alt="skill-icon" />
                  </li>
                </ul>
              </div>
            </div>
